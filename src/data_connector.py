    ...
    def bulk_load(self, object, soql, header_columns=None, csv_file=None):
        ...
        if csv_file:
            ...
            with open(csv_file, open_mode) as f_csv:
                ...
                for i, result_set in enumerate(self.bulk.get_all_results_for_batch(batch, job_id=job, parse_csv=True, logger=None)):
            ...
            return dict_adapter.get_dict(self.return_result_rows(self.bulk.get_all_results_for_batch(batch, job_id=job, parse_csv=True, logger=None)))
