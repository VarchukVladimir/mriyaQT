...
class SalesforceBulk(object):
    ...
    def headers(self, values={}):
        ...
        # , "Sforce-Enable-PKChunking": "chunkSize=5000;"
...
#            query_job_id, query_batch_id, callback=save_results)
    ...
    def count_file_lines(self, tf):
        ...
        return lines
    def describe_object(self, sObjectName):
        print(self.endpoint)
        print(self.headers())
        # /services/data/v23.0/sobjects/ObjectName/describe

        uri = "https://rackspace--core.cs62.my.salesforce.com/services/data/v37.0/sobjects/Accounts__c/describe"
        print(uri)
        headers = self.headers()
